...
public class Globals {
    public static final String WEATHER_CITY_EVENT = "city-weather";
    public static final String ONE_CITY_WEATHER_EXTRA = "one-city-name";
    public static final String CITY_NAME_EXTRA = "city-name";
    public static final String CITY_NAME = "city_name";

    public static final int CITY_DETAILS_REQ_CODE = 1;
    public static final String CITY_WAS_REMOVED = "city-was-removed";
    public static final String CITY_NAME_TO_BE_REMOVED = "city-name-to-be-removed";
    ...
    public static final String LOG_TAG = "WA01";
